...
{
  public static string EXIT_ROOM_TAG = "ExitRoom";
  public static string EXIT_HALL_TAG = "ExitHall";
  public static string ROOM_TAG = "Room";
  public static string HALL_TAG = "Hall";
  ...
  public static string SPAWN_01_TAG = "SpawnRobot01";
